...
let db= new sqlite3.Database('./MolinaBBDD.db', sqlite3.OPEN_READWRITE | 
...
function borrarUsu(usuario,fun){
...
function insertarUsu(usuario,password,perm,fun){
...
function actualizarUsu(usuario,password,fun){
    let password_salt = ''
    let password_hash = ''
    hash({ password: password }, function (err, pass, salt, hash) {
        if (err) throw err;
...
function loginUsu(usuario,pwd,fun){
...
exports.db=db; 
exports.crearBBDD=crearBBDD;
exports.borrarUsu=borrarUsu;
exports.insertarUsu=insertarUsu;
exports.actualizarUsu=actualizarUsu;
exports.loginUsu=loginUsu;